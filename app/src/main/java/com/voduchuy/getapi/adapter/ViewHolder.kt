...
//class ViewHolder(private val binding: ItemViewBinding, private val context: MainActivity? = null) :
...
//        binding.tvDelete.setOnClickListener { context!!.deleteData(user.id) }
